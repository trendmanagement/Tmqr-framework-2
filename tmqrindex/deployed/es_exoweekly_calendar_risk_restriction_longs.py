...
class ES_EXOWeeklyCalendarRiskRestrictionLongs(IndexEXOBase):
    _description_short = "Hedge a Long Alpha"
    _description_long = ""

    _index_name = "EXOWeekly_Calendar_risk_restriction_longs"
    ...
    def construct_position(self, dt, pos, logic_df):
        ...
        # Selling ATM call
        fut, opt_chain = self.dm.chains_options_get(self.instrument, dt, opt_codes=['EW2', 'EW4'])
