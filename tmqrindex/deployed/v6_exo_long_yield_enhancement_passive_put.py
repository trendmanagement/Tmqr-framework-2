...
class EXO_Long_Yield_Enhancement_Passive_Put(IndexEXOBase):
    _description_short = "EXO_Long_Yield_Enhancement_Passive_Put"
    _description_long = ""

    _index_name = "EXO_Long_Yield_Enhancement_Passive_Put"
    ...
    def construct_position(self, dt, pos, logic_df):
        ...
        pos.add_transaction(dt, opt_chain.find(dt, 0.01, 'P', how='delta', opt_offset=1), 2.0)