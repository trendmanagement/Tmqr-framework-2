...
class EXO_Short_Yield_enhancement_active(IndexEXOBase):
    _description_short = "EXO_Short_Yield_enhancement_active"
    _description_long = ""

    _index_name = "EXO_Short_Yield_enhancement_active"
    ...
    def construct_position(self, dt, pos, logic_df):
        ...
        pos.add_transaction(dt, opt_chain.find(dt, 0.15, 'C', how='delta', opt_offset=1), -1.0)
        pos.add_transaction(dt, opt_chain.find(dt, 0.55, 'P', how='delta', opt_offset=0), -1.0)