...
class EXO_Passive_leg_Long_Put_For_Bullish_Futures(IndexEXOBase):
    _description_short = "EXO_Passive_leg_Long_Put_For_Bullish_Futures"
    _description_long = ""

    _index_name = "EXO_Passive_leg_Long_Put_For_Bullish_Futures"
    ...
    def manage_position(self, dt, pos, logic_df):
        ...
        if days_after_last_trans > 10:
            log.debug("Business days > 10, closing position")
            #    # Close the position
            pos.close(dt)
    ...
    def construct_position(self, dt, pos, logic_df):
        ...
        pos.add_transaction(dt, opt_chain.find(dt, 0.35, 'P', how='delta'), 1.0)