...
class EXO_Passive_leg_Long_Call_For_Bearish_Futures(IndexEXOBase):
    _description_short = "EXO_Passive_leg_Long_Call_For_Bearish_Futures"
    _description_long = ""

    _index_name = "EXO_Passive_leg_Long_Call_For_Bearish_Futures"
