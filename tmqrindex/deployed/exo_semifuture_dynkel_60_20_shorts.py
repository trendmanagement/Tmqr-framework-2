...
class EXOSemiFuture_DynKel_60_20_shorts(IndexEXOBase):
    _description_short = "EXO Vanilla DeltaTargeting DynKel Delta Risk Reversal"
    _description_long = ""

    _index_name = "EXOSemiFuture_DynKel_60_20_shorts"
    ...
    def construct_position(self, dt, pos, logic_df):
        ...
        if logic_df['keltner_direction_current'] == True:
            ...
            pos.add_transaction(dt, opt_chain.find(dt, 0.40, 'C', how='delta'), 1.0)
        else:
