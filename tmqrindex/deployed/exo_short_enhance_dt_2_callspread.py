...
class EXOShortEnhance_DT_2_CallSpread(IndexEXOBase):
    _description_short = "EXO Vanilla DeltaTargeting ShortEnhance_CallSpread"
    _description_long = ""

    _index_name = "EXOShortEnhance_DT_2_CallSpread"
