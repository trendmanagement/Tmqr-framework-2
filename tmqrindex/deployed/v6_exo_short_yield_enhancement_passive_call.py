...
class EXO_Short_Yield_Enhancement_Passive_Call(IndexEXOBase):
    _description_short = "EXO_Short_Yield_Enhancement_Passive_Call"
    _description_long = ""

    _index_name = "EXO_Short_Yield_Enhancement_Passive_Call"
    ...
    def construct_position(self, dt, pos, logic_df):
        ...
        pos.add_transaction(dt, opt_chain.find(dt, 0.01, 'C', how='delta', opt_offset=1), 2.0)