...
class EXO_RiskReversal_Passive_Puts_For_Shorts(IndexEXOBase):
    _description_short = "EXO_RiskReversal_Passive_Puts_For_Shorts"
    _description_long = ""

    _index_name = "EXO_RiskReversal_Passive_Puts_For_Shorts"
